### Deploy 5-Microservices Architecture on EC2 Instance on 2-Node (Master & Worker) K3s Kubernetes Cluster
* Use IAM, ECR for access & artifact management. 
* Automated CI/CD through Github Actions & ArgoCd.
